...
<body>
<%String message=(String)session.getAttribute("Student_updateInformation.message");
...
<%}%>
  ...
  <div class="body-content">
    ...
    <input type="hidden" name="jsp" value="Student_update_Information"/>
    ...
    <!-- <input type="hidden" name="message1" value=""> -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherStname" size="50" placeholder="请输入新性别" />         
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSsex" size="50" placeholder="请输入新年龄" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSage" size="50" placeholder="请输入新院系" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSto" size="50" placeholder="请输入新班级" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
