...
<body>
<%String message=(String)session.getAttribute("TeacherManagerUpdate.message");
if(message!=null){%>
...
<%}%>
  ...
  <div class="body-content">
    ...
    <input type="hidden" name="jsp" value="TeacherManagerUpdate"/>
    <!-- <input type="hidden" name="message1" value=""> -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherStname" size="50" placeholder="请输入新教师名" />         
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSto" size="50" placeholder="请输入新职称" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
