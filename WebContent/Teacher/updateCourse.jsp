...
<%String message=(String)session.getAttribute("Student_update");
  String Sno=request.getParameter("Cno");
...
<%}%>
  ...
  <div class="body-content">
    ...
    <input type="hidden" name="jsp" value="Student_update_Course"/>
    <input type="hidden" name="Stno" value="<%=Sno%>"/>
    <!-- <input type="hidden" name="message1" value=""> -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSsex" size="50" placeholder="请输入新学分" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSage" size="50" placeholder="请输入新班号" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
