...
<body>
  ...
  <div class="body-content">
    ...
    <input type="hidden" name="jsp" value="AddCourse"/>
    <!-- <input type="hidden" name="message1" value=""> -->
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="mTeacherStno" name="mTeacherStno" size="50" placeholder="新课程号" on data-validate="required:新课程号" />       
        </div>
      </div>  
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSsex" size="50" placeholder="请输入新学时" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSage" size="50" placeholder="请输入新学分" />          
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" name="mTeacherSto" size="50" placeholder="请输入新类型" />          
        </div>
      </div>
